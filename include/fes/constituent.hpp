...
constexpr auto all = std::array<Constituent, kNumConstituents>{
    ...
    kMu2,   k2MS2,  kN2,   kNu2,    kMA2,  kM2,     kMB2,  kMKS2,  kLambda2,
    kL2,    k2MN2,  kT2,   kS2,     kR2,   kK2,     kMSN2, kEta2,  k2SM2,
    kMO3,   k2MK3,  kM3,   kS3,     kMK3,  kN4,     kMN4,  kM4,    kSN4,
    kMS4,   kMK4,   kS4,   kSK4,    kR4,   k2MN6,   kM6,   kMSN6,  k2MS6,
    k2MK6,  k2SM6,  kMSK6, kS6,     kM8,   kMSf,    kSsa,  kSa,    kSa1,
    kSta,   kMm1,   kMf1,  kA5,     kM0,   kMm2,    kMf2,  kL2P,   kN2P,
    kMSK2,  kSKM2,  kOQ2,  k3MS4,   kMNu4, k2MSN4,  k2NS2, kMNuS2, k2MK2,
    kNKM2,  kML4,   kSO1,  kSO3,    kNK4,  kMNK6,   k2NM6, k3MS8,  kSK3,
    k2MNS4, k2SMu2, k2MP5};
