...
constexpr auto kConstituentNames =
    std::array<const char* const, kNumConstituents>{
        ...
        "M1",    "M11",   "M12",   "M13",    "MA2",  "M2",      "MB2",
        "M3",    "M4",    "M6",    "M8",     "Mf",   "Mf1",     "Mf2",
        "MK3",   "MK4",   "MKS2",  "ML4",    "Mm",   "Mm1",     "Mm2",
        "MN4",   "MNK6",  "MNS2",  "MNu4",   "MNuS2", "MO3",    "MP1",
        "Mqm",   "MS4",   "MSf",   "MSK2",   "MSK6", "MSm",     "MSN2",
        "MSN6",  "MSqm",  "MStm",  "Mtm",    "Mu2",  "N2",      "N2P",
        "N4",    "NK4",   "NKM2",  "Node",   "Nu2",  "O1",      "OO1",
        "OQ2",   "P1",    "Phi1",  "Pi1",    "Psi1", "Q1",      "R2",
        "R4",    "Rho1",  "S1",    "S2",     "S3",   "S4",      "S6",
        "Sa",    "Sa1",   "Sigma1", "SK3",   "SK4",  "SKM2",    "SN4",
        "SO1",   "SO3",   "Ssa",   "Sta",    "T2",   "Tau1",    "Theta1",
        "Ups1",
    };
